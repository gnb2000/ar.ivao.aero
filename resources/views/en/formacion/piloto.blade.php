        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="card">
             ...
             <ul class="list-group">
                    <li class="list-group-item"><a href="https://mediawiki.ivao.aero/index.php?title=Private_Pilot_briefing">
          ...
          <div class="col-md-4">
            ...
            <div class="card">
             ...
             <ul class="list-group">
                    <li class="list-group-item"><a href="https://mediawiki.ivao.aero/index.php?title=Senior_Private_Pilot_briefing">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Briefing Guide</strong> <strong class="float-right"><i class="fa fa-file-pdf-o fa-fw"></i></strong>
                    </a></li>
                    <li class="list-group-item"><a href="/es/formacion/biblioteca">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Manuales Biblioteca</strong> <strong class="float-right"><i class="fa fa-book fa-fw"></i></strong>
          ...
          <div class="col-md-4">
            ...
            <div class="card">
             ...
             <ul class="list-group">
                    <li class="list-group-item"><a href="https://mediawiki.ivao.aero/index.php?title=Commercial_Pilot_briefing">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Briefing Guide</strong> <strong class="float-right"><i class="fa fa-file-pdf-o fa-fw"></i></strong>
                    </a></li>
                    <li class="list-group-item"><a href="/es/formacion/biblioteca">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Manuales Biblioteca</strong> <strong class="float-right"><i class="fa fa-book fa-fw"></i></strong>
