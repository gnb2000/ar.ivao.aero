...
<?php
	...
	$salida = 'N/A';
	        ...
	        if($paiss == 'Argentina')
	        {
	            echo 'DEP:'.$etod.':'.$pilot[0].':'.$airline.':'.$pilot[11].':'.$pilot[13].':'.substr($pilot[9],2,4).':'.$salida.':'.$pilot[46].'<br>';
	        }
	    } 
	}
	?>
<?php
	...
	$paiss = $filas['pais'];
	        ...
	        if($paisll == 'Argentina')
	        {
	            echo 'ARR:'.$textETA.':'.$pilot[0].':'.$airline.':' .$pilot[11]. ':' .$pilot[13]. ':'.substr($pilot[9],2,4). ':'.$llegada.':'.$pilot[46].'<br>';
	        }
	    } 
	}
	?>