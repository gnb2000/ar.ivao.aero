...
<h2>Entrenamiento <small> Gestionar Entrenamientos</small><br />
                  ...
                  <!-- Si hay trainings de ATC, mostramos el titulo de la seccion y mostramos los trainings -->
                    ...
                    <tr>
                       ...
                       <td><a href="/intraweb/training/{{$atc->id}}/assign" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="Asignar Entrenador"><img src="http://ar.ivao.aero/img/ico/pencil.png"></a> <a href="/intraweb/training/{{$atc->id}}/delete" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="Cancelar Solicitud"><img src="http://www.ar.ivao.aero/img/ico/cross-circle.png"></a></td>
                    </tr>           
                    @endforeach 
                  @endif
                  ...
                  <tr class="bg-primary3">
                    ...
                    <tr>
                       ...
                       <td><a href="/intraweb/training/{{$piloto->id}}/assign" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="Asignar Entrenador"><img src="http://ar.ivao.aero/img/ico/pencil.png"></a> <a href="/intraweb/training/{{$piloto->id}}/delete" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="Cancelar Solicitud"><img src="http://www.ar.ivao.aero/img/ico/cross-circle.png"></a></td>
                    </tr>              
                    @endforeach 
                  @endif   
