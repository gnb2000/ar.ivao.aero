         ...
         <div class="row">
            <div style="border-top-width: 4px;" class="col-3 text-center">
					<div class="card bg-light text-center mr-4 mb-4">
               		...
               		<h2 style="color: #EAAF0F !important;"><i class="fas fa-bookmark"></i> Shortcuts</h2>
						</div>
						<div class="card-body">
            ...
            <div class="col-6 text-center">
               ...
               <div class="card bg-light text-center mr-4 mb-4">
                  	...
                  	<h2 style="color: #00B28C !important;"><i class="far fa-newspaper"></i> News</h2>
						</div>
						<div class="card-body">
            ...
            <div class="col-3 text-center">
            	...
            	<div class="col">
               	<div class="card bg-light text-center mr-4 mb-4">
						<div class="card-header">
                		<h2 style="color: #2A4982"><i class="fas fa-calendar-alt"></i> Calendar</h2>
						</div>
						<div class="card-body">
                 ...
                 <a href="/comunidad/calendario" class="btn btn-default btn-block">See All »</a>
						</div>
					</div>
				</div>
				</div>
