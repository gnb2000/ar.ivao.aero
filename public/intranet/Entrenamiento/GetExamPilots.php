...
$resPilotos = mysqli_query($con, 
						   ...
						   FROM training_flights of, exams e
						   WHERE (
						   of.conn_time BETWEEN DATE_SUB(e.dt, INTERVAL 1 HOUR) AND DATE_ADD(e.dt, INTERVAL 2 HOUR)
						   OR of.disc_time BETWEEN e.dt AND DATE_ADD(e.dt, INTERVAL 3 HOUR) )
						   AND e.id = $id")
