...
<h2>Entrenamiento <small> Programar Examen</small></h2>
<br />

@include('flash::message')
<form enctype="multipart/form-data" class="form-horizontal" id="formulario" action="{{action('TrainingController@examSchedule')}}" method="post">
  @csrf
<fieldset>
