...
?>                        
              ...
              <h2>Entrenamiento <small> Ex&aacute;menes Completados</small></h2>
...
<div class="form-group">
  ...
  <div class="col-md-3">
      ...
      <?php
      $resUsers = mysqli_query($con, 'SELECT DISTINCT vid FROM exams ORDER BY vid');
...
<div class="form-group">
  <div class="col-md-4">
	<input onclick="enviarForm('Entrenamiento/ExamsList.php?enviar=enviar', '.tooltip-demo')" type="button" class="btn btn-success btn-xs" name="enviar" value="OK">
