  ...
  <!-- DOS COLUMNAS -->
    ...
    <div class="tabla-novedades">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item"><a class="nav-link" href="#manuales" data-bs-toggle="tab">Manuals</a></li>
              <li class="nav-item"><a class="nav-link" href="#briefing" data-bs-toggle="tab">Briefings</a></li>
              <li class="nav-item"><a class="nav-link" href="#icao" data-bs-toggle="tab">ICAO / ANAC Documents</a></li>
            </ul>
      ...
      <div class="separacion-tablas"></div>
              <table class="table table-striped">
                 ...
                 <tbody>
                  @foreach($manuales as $manual)
                            <tr>
                              ...
                              @endif
                              <td>{!! $manual->author !!}</td>
                              <td><a href="http://files.ar.ivao.aero/Training/Manuales/{{$manual->file}}" class="btn btn-primary btn-sm">Download</a></td>
                            </tr>
  						  @endforeach
                 </tbody>
             </table>      
				...
				<div role="tabpanel" class="tab-pane" id="briefing">
