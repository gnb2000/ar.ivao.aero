...
<h2>Flight Status: <small>{{$cs}}</small></h2><br>
...
<strong style="letter-spacing: 2px;text-transform: uppercase;">Departure</strong> 
...
padding-bottom: 8px; padding-right: 15px;" width="42"> <strong style="letter-spacing: 2px;text-transform: uppercase;">Arrival</strong>
                            ...
                            <span style="margin-bottom: 10px; font-size: 14px; color: #999;" data-toggle="tooltip" data-placement="right" title="Ruta de Vuelo">Route:</span><br>
