        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <div class="card">
             ...
             <ul class="list-group">
                    <li class="list-group-item"><a href="https://mediawiki.ivao.aero/index.php?title=Aerodrome_Controller_briefing">
                    ...
                    <li class="list-group-item"><a href="/es/formacion/biblioteca">
          ...
          <div class="col-sm-4">
            ...
            <div class="card">
             ...
             <ul class="list-group">
                    <li class="list-group-item"><a href="https://mediawiki.ivao.aero/index.php?title=Approach_Controller_briefing">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Briefing Guide</strong> <strong class="float-right"><i class="fa fa-file-pdf-o fa-fw"></i></strong>
                    </a></li>
                    <li class="list-group-item"><a href="/es/formacion/biblioteca">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Manuales Biblioteca</strong> <strong class="float-right"><i class="fa fa-book fa-fw"></i></strong>
          ...
          <div class="col-sm-4">
            ...
            <div class="card">
             ...
             <ul class="list-group">
                    <li class="list-group-item"><a href="https://mediawiki.ivao.aero/index.php?title=Area_Controller_briefing">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Briefing Guide</strong> <strong class="float-right"><i class="fa fa-file-pdf-o fa-fw"></i></strong>
                    </a></li>
                    <li class="list-group-item"><a href="/es/formacion/biblioteca">
                        <i class="fas fa-angle-right fa-fw"></i> <strong>Manuales Biblioteca</strong> <strong class="float-right"><i class="fa fa-book fa-fw"></i></strong>
