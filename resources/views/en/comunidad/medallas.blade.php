...
<section>
    ...
    <div class="row">
      <div class="col-3">
        <div class="list-group" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#divisionales" role="tab" id="divisionales-item"  aria-controls="divisionales">Medallas Divisionales</a>
    ...
    <div class="col-9">
      ...
      <tbody>
        <tr>
          <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/HR.png" /></td>
          <td>Honor</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</td>
        </tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/BI.png" /></td>
          <td>Idea Brillante</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</td>
        </tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/CR.png" /></td>
          <td>Creatividad</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</td>
        </tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/CC.png" /></td>
          <td>Disertador</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/PP.png" /></td>
          <td>Relaciones Públicas</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/NW.png" /></td>
          <td>Nuevo Usuario 2.0</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/AM.png" /></td>
          <td>ATC del Mes</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/PM.png" /></td>
          <td>Piloto del Mes</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/IM2.png" /></td>
          <td>En Memoria</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/C2.0.png" /></td>
          <td>Website Designer 2.0</td>
          <td>Entregada a los diseñadores de la Web 2.0. Controlada por AR-WM y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/D2.png" /></td>
          <td>Website Developer 2.0</td>
          <td>Entregada a los desarolladores de la Web 2.0. Controlada por AR-WM y expedida por AR-WM/AWM.</tr>
        <!--<tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/FS.png" /></td>
          <td>AR Division STAFF Former</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/FS_HQ.png" /></td>
          <td>HQ STAFF Former</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>-->
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/EO.png" /></td>
          <td>Evento</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.<tr>
        </tr>
        <tr>
        <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/EP.png" /></td>
          <td>Evento Presencial</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
          <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/SE.png" /></td>
          <td>Evento Especial</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
          <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/SA15.png" /></td>
          <td>STAFF del Año 2015</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        <tr>
          <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/SA16.png" /></td>
		...
		<tr>
          <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/EAA.png" /></td>
          <td>Participante de la EAA</td>
          <td>Controlada por AR-HQ y expedida por AR-WM/AWM.</tr>
        </td>
		<tr>
          <td><img alt="medalla" class="img-thumbnail-4" src="https://ar.ivao.aero/images/medallas/4K.png" /></td>
          <td>400.000 Horas de IVAO Argentina</td>
          <td>Controlada por AR-EC/EAC y expedida por AR-WM/AWM.</tr>
        </td>
      </tbody>
    </table>
    	...
    	<div role="tabpanel" class="tabpane fade show" id="divisionales" aria-labelled-by="divisionales-item">
