...
<form class="form-horizontal" id="formulario" action="{{action('StaffController@add')}}" method="post" role="form">
  @csrf
    <div class="form-group">
      <label class="col-md-4 control-label" for="vid">Usuario</label>  
      <div class="col-md-4">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <select id="position" name="position" class="form-control input-md" required>
        <option value="">Seleccionar...</option>
