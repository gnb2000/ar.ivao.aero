...
<div class="form-group col-md-4">
  <label class="control-label" for="leg">Pierna</label>
...
<div class="form-group col-md-4">
  <label class="control-label" for="fechainicio">Hora Despegue (UTC)</label>
  <input autocomplete="off" class="form-control input-md"  id="fechainicio" name="dep_time" type="text" required />
</div>

<div class="form-group col-md-4">
  <label class="control-label" for="fechafin">Hora Aterrizaje (UTC)</label>
