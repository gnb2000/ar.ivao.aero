...
{  
	echo'<tr>
              ...
              <td>'; ?>
			  <a onClick="if(confirm('&iquest;Est&aacute; seguro de que quiere eliminar el evento?')) mostrarAJAX('Eventos/EventDel.php?id=<?php echo $filaEventos['id']; ?>&lang=es', '.tooltip-demo');" data-original-title="Eliminar" role="button" class="btn btn-danger btn-xs" href="#">
			  Eliminar
			  </a>
              </td>
              <?php
