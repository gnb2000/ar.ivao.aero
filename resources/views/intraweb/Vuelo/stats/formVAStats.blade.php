   ...
   <div class="tabla-novedades">
   	...
   	<div class="row">
        ...
        <div class="tooltip-demo">
                      ...
                      <!-- INICIO CONTENIDO -->
<h2>Participaci&oacute;n VAs <small> Territorio Argentino</small></h2>
<br />
...
<form class="form-horizontal" action="{{action('OnlineController@VAParticipation')}}" method="post" role="form">
  @csrf
  <fieldset>
    <!-- Text input-->
...
<script src="/js/EventStats.js" type="text/javascript"></script>
