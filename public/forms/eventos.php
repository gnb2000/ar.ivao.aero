<?php	
	...
	$buscar = "SELECT * FROM staff_members WHERE vid = '$vid' AND (departamento = 'EVENTSS' OR permisos = 'ADM' OR departamento = 'PRDSS') "; //
	...
	if($count != 0)
	{
		...
		{	
			...
			$target_dir2 = "/home/admin/web/files.ivao.com.ar/public_html/Eventos/Images/Thumb/";
			...
			if($_FILES['imagen']['tmp_name'] != '')
			{
				...
				else $errErrorImage = "Sorry, there was an error uploading your file.";
	
			}
		}
		if(isset($_POST['subir_file']))//para saber si el botón registrar fue presionado.
		{		
			$target_dir = "/home/admin/web/files.ivao.com.ar/public_html/Eventos/";
			...
			{
				if(move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) $errExitoFile = "File URL: https://files.ivao.com.ar/Eventos/". basename( $_FILES['file']['name']). "";
				
				else $errErrorFile = "Sorry, there was an error uploading your file.";
			}
		}
...
<table style="width:100%">
	<tr>
		<td>
			<form enctype="multipart/form-data" action="eventos.php" method="post" class="form-horizontal">
				<fieldset>
					<!-- Form Name -->
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							...
							<span class="help-block">Agregar el banner de un evento al servidor.</span>  
						</div>
					</div>
					<!-- Button (Double) -->
					<div class="form-group">
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							...
							<span class="help-block">Agregar un archivo al servidor.</span>  
						</div>
					</div>
					<!-- Button (Double) -->
					<div class="form-group">
						<label class="col-md-4 control-label" for="agregar"></label>
						<div class="col-md-8">
							<button value="Agregar" id="subir_file" name="subir_file" class="btn btn-success">Agregar</button>
							<button id="clean" name="clean" class="btn btn-danger">Limpiar</button>
						</div>
					</div>
				</fieldset>
...
<?php
		...
		else echo 'Sin autorizaci&oacute;n';
		?>
