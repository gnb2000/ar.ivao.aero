...
@section('titulo')
<title>Contact :: IVAO Argentina</title>
@endsection
...
<section>
  ...
  <!-- DOS COLUMNAS -->
        ...
        <div class="tabla-novedades">
                    ...
                    <h2 class="title"><i class="glyphicon glyphicon-envelope fa-fw"></i> Contact Form<span class="line"></span></h2>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9 required-field-block">
                            ...
                            <option value="Cambio Division">Division Change</option>
                            <option value="Datos Personales">Personal Data</option>
                            <option value="Denuncia">Complaint</option>
                            <option value="Eventos">Events</option>
                            <option value="Tours">Tours</option>
                            <option value="Registro VA">VAs</option>
                            <option value="Error general">Web / General Error</option>
                            <option value="Codigo">Web / Code (Error 403, 404, 500...)</option>
                            <option value="Corte del Servicio">Web / Service disruption</option>
                            <option value="Discord">Discord</option>
                            <option value="Primeros Pasos">First Steps on IVAO</option>
                            <option value="Software / Instalar">Software / Setup</option>
                            <option value="Software / Error">Software / Error</option>
                            <option value="GCA">GCA</option>
                            <option value="Entrenamiento ATC">ATC Training</option>
                            <option value="Entrenamiento Piloto">Flight Training</option>
                            <option value="ATC">ATC Operations</option>
                            <option value="SO">Special Operations</option>
                            </select>
                        ...
                        <div class="form-group">
                          <div class="col-md-9">
                         <input type="submit" onClick="guardarDatos();" value="Send Form" class="btn btn-outline btn-success btn-lg">
                          </div><!-- /.col-md9 -->
                        </div><!-- /.form-group -->
